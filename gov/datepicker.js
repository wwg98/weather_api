  ...
  var b = (function () {
    function e(n, i) {
      ...
      (n || (n = document.createElement("input")),
        "input" !== n.tagName.toLowerCase() || /input|hidden/i.test(n.type) || (n.type = "text"),
        this._initDOM(n),
        this._initOptions(i),
        this._initEvents(),
      ...
      n(e, [
          ...
          value: function () {
            ...
            var n = function (e, t) {
              ...
              a = function (e, t) {
                var n = t.deserialize;
                return (
                  e.length && ((e = f(_(e, n, this))), (e = [].concat(e).filter(p))),
                  !!e.length && e
                );
              }.bind(this),
              r = function (e, t) {
        ...
        },
        {
          ...
          value: function (e) {
            ...
            ((n && !this._isDragging) || ((this._highlighted = []), (this._dragStart = null)),
              (this._isDragging = !1));
          },
        },
        {
          ...
          value: function (e, t) {
            if (e) {
              if (m(e)) {
                ...
                e.serialize && (this.set("serialize", e.serialize), delete e.serialize),
                e.deserialize && (this.set("deserialize", e.deserialize), delete e.deserialize),
                e))
                  this.set(n, e[n]);
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (arguments.length > 1)
              return [].concat(Array.prototype.slice.call(arguments)).reduce(function (e, n) {
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            ((o = (o = o.map(function (e) {
              ...
              a
                ? (o = (o = o.concat(this.getDate()).sort(c)).length ? g(o[0], o.pop()) : [])
                : r || (o = o.slice(0, 1)),
              o
                .map(function (e) {
                  return f(e).getTime();
                ...
                renderTimepicker: function () {
                  ...
                  return (
                    a &&
                      ...
                      ("ranged" === a || n) && (t += e._renderTimepicker("end"))),
                    t
                  );
                },
              })),
